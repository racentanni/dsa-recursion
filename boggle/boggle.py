...
def find_from(board, word, y, x, seen):
    ...
    #Base case: This isn't the letter we are looking for
    ...
    #Base case: we used this letter before in this current path
    ...
    if x < 4:
        if find_from(board, word[1:], y, x + 1, seen):
            ...
            #Can't find the last letter, so this path is dead
